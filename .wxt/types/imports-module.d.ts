...
declare module '#imports' {
  ...
  export { loadData, saveData, exportData, importData, generateId } from '../utils/storage';
  export { defaultSettings, defaultData, Bookmark, SidebarSettings, SidebarData } from '../utils/types';
}
